		...
		userFilesDropzone: {
			...
			initFileUploader: function(base, target) {
				...
				var onyxDropzone = new Dropzone(target, {
					 ...
					 */
					dictDefaultMessage: "Glisser les fichiers ici pour les envoyer.", // Default: Drop files here to upload
					 ...
					 */
					dictFileTooBig: "Fichier trop volumineux ({{filesize}}MiB). Taille maximale: {{maxFilesize}}MiB.", // Default: File is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.
					 ...
					 */
					dictMaxFilesExceeded: "Tu ne peux pas envoyer plus de fichier.", // Default: You can not upload any more files.
...
$("#validateNewFolderName").click(function () {
